...
urlpatterns = [
     ...
     # 配置3个图表显示的路由
     url(r'^temperatureSensorChart/$', views.temperatureSensorChart),#温度传感器数据图表
     url(r'^humiditySensorChart/$', views.humiditySensorChart),#湿度传感器数据图表
     url(r'^floodlightSensorChart/$', views.floodlightSensorChart),#光照传感器数据图表
]